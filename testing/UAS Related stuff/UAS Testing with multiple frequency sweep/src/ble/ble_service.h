...
//     Characteristic FREQ_CMD  (write):  float32 LE, AD9833 drive frequency in Hz —
//       applied immediately (see uasSetFrequency()). Added for the web-driven
//       UAS frequency sweep; not part of the original v3.4 bring-up protocol.
...
struct TelemetryPacket {
	float uasVolts;
	float uasFreqHz;      // drive frequency the uasVolts reading was taken at
	uint16_t sgResultM1;
	uint16_t sgResultM2;
	int32_t positionM1;
	int32_t positionM2;
