...
bool scheduler_start() {
    ...
    // Which stop condition applies for this run — cached once here from
    ...
    if (_isViscosityRun) {
        ...
        // specific to Size) — this run stops via the continuous
        // position-gated force->viscosity check instead, see the
