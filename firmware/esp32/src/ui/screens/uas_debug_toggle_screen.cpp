...
void UasDebugToggleScreen::_draw() {
    ...
    ui_display_draw_centered("UAS Debug Mode", 25, TFT_WHITE, 1);
    tft.setFont(&fonts::FreeSans9pt7b);
    ui_display_draw_centered("Turning this on will enable", 90, COLOR_LUNAR_ROCK, 1);
    ui_display_draw_centered("Bluetooth (EMBO-Debug)", 115, COLOR_LUNAR_ROCK, 1);
