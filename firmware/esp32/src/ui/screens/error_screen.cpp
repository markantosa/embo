...
void ErrorScreen::update(ScreenManager &mgr, bool forceFull) {
    ...
    ui_display_draw_centered("HARDWARE FAULT", 100, TFT_RED, 2);
    ui_display_draw_centered(_msg, 140, TFT_RED, 2);
    ui_display_draw_centered("Reboot required", 200, TFT_DARKGREY, 2);
}
